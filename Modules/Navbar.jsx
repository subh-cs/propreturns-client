  ...
  return (
    ...
    <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        <a href="https://propreturns.com" className="flex items-center">
          <img
            src="https://s3-us-west-2.amazonaws.com/cbi-image-service-prd/modified/0d47393a-dc4b-4cde-9ee4-551623cfd14c.png"
